...
- `sequence_key`: exact normalized sequence identity for deduplication and caps; the canonical candidate pool keeps one evidence-prioritized mother-sample representative per key.
