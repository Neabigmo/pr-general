...
- The current local snapshot produces 43,595 cap-valid training candidates after strict holdout reservation and before external structure prediction; the configured 100,000 target remains blocked by the exact-protein cap and available sequence diversity.
